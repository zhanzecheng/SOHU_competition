# -*- coding: utf-8 -*-
"""
# @Time    : 2018/7/6 下午2:55
# @Author  : zhanzecheng
# @File    : lstmgru_model.py
# @Software: PyCharm
"""
...
class LstmgruModel(BasicModel):
    def __init__(self, maxLen, ocrLen, max_features, init_embedding_matrix, name='basicModel', num_flods=4, batch_size=64):
        BasicModel.__init__(self, maxLen, ocrLen, max_features, init_embedding_matrix, name='lstmgru', num_flods=num_flods,
